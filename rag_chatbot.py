...
class ParkinsonRAG:
    ...
    def generate_rag_answer(self, query: str, test_results: Dict[str, Any], top_k: int = 3) -> str:
        ...
        system_prompt = (
            ...
            "답변 원칙:\n"
            "1. 전문 용어는 쉽게 풀어서 할머니/할아버지에게 말씀드리듯 설명하세요.\n"
            "2. 절대로 단정적인 진단(예: 파킨슨병입니다)을 내리지 마시고, 병원 상담을 권유하세요.\n"
            "3. 논문 출처나 근거 번호 등은 절대 말하지 말고, 그 내용만 자연스럽게 녹여내세요.\n"
            "4. 불안해하지 않도록 따뜻한 위로와 긍정적인 다독임을 함께 해주세요.\n"
        )
